...
public class RightyLucyDriveConstants implements DriveConstants {
    ...
    private static final double GEAR_RATIO = 0.0540; // output (wheel) speed / input (motor) speed // reduced gear ratio = increased distance
//     private static final double GEAR_RATIO = 0.0.0524505; // output (wheel) speed / input (motor) speed
    ...
    private static final double MAX_VEL = 28;
    private static final double MAX_ACCEL = 8.5;
    private static final double MAX_ANG_VEL = 2;
    private static final double MAX_ANG_ACCEL = 1.3;

    private static final PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(20, 0, 1.2); // TODO: change back to 1.6 if terrible
    private static final PIDCoefficients HEADING_PID = new PIDCoefficients(15, 0, 1.2);
//    private static final double LATERAL_MULTIPLIER = 1.14949;
    private static final double LATERAL_MULTIPLIER = 1.077; // the higher the value, the longer the distance it moves
