...
public class RightRepository extends TrajectoryRepository {

    public static Pose2d INITIAL_POSITION = new Pose2d(-35.8, 64, Math.toRadians(270));
    ...
    public static Pose2d STACK_POSITION = new Pose2d(-59.5, 12.5, Math.toRadians(180));
