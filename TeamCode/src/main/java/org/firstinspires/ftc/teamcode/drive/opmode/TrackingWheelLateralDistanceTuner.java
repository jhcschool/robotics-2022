 ...
 * Tuning Routine:
 * <p>
 * 1. Set the LATERAL_DISTANCE value in DeadWheelLocalizer.java to the physical
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (!(drive.getLocalizer() instanceof DeadWheelLocalizer)) {
            RobotLog.setGlobalErrorMsg("DeadWheelLocalizer is not being set in the "
                    ...
                    + "(hardwareMap));\" is called in GrizzlyDrive.java");
        }
        ...
        telemetry.addLine("Effective LATERAL_DISTANCE: " +
                (headingAccumulator / (NUM_TURNS * Math.PI * 2)) * DeadWheelLocalizer.LATERAL_DISTANCE);
