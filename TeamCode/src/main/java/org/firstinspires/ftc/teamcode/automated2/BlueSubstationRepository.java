...
public class BlueSubstationRepository extends TrajectoryRepository {
    ...
    private static Pose2d INITIAL_POSITION = new Pose2d(-36, 63, Math.toRadians(270));
    private static Pose2d JUNCTION_POSITION = new Pose2d(-24, 12, Math.toRadians(270));
    private static Pose2d STACK_POSITION = new Pose2d(-58, 12, Math.toRadians(180));

    private Drive drive;
    public BlueSubstationRepository(Drive drive)
    {
